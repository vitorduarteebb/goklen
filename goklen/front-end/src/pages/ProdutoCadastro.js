...
function CadastroAviamentos() {
  const [formData, setFormData] = useState({
    nome: '',
    descricao: '',
    cor: '',
    quantidade_em_estoque: '', // iniciando como string para evitar conversão prematura
  ...
  const handleSubmit = (e) => {
    ...
    // Converter os valores numéricos ou definir null se vazio
    const submitData = {
      ...formData,
    ...
    // Se estiver usando ViesViewSet, provavelmente a URL correta é "/api/vies/".
    axios
      .post('http://localhost:8000/api/vies/', submitData)
      .then((response) => {
...
export default CadastroAviamentos;
